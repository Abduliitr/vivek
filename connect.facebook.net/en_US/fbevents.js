                ...
                (function() {
                    ...
                    function r(a) {
                        ...
                        if (h != null) {
                            ...
                            i && p === 0 && h.isInExperimentGroup && (d.logStartBatch(),
                            setTimeout(q, 0));
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, i, k) {
                ...
                (function() {
                    ...
                    var H = {}, I = -1, da = Array.prototype.slice, J = Object.prototype.hasOwnProperty, K = i.href, L = !1, M = !1, N = [], O = {}, P;
                    h.referrer;
                    var Q = {
                        PageView: new l(),
                        PixelInitialized: new l()
                    }
                      , R = new p(a,O);
                    function ea(a) {
                        for (var b in a)
                    ...
                    function $(b) {
                        ...
                        b = q.CONFIG.CDN_BASE_URL + "signals/plugins/" + b + ".js?v=" + a.version;
                        if (!H[c]) {
                            G.lockPlugin(c);
                            q.loadJSFile(b);
                            return !0
