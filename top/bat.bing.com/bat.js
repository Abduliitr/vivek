function UET(o) {
    ...
    this.checkuetHostdocumentload = function() {
        if (this.documentLoaded = !!document.body,
        n.documentLoaded) {
    ...
    this.loadConfig = function() {
        ...
        o.hasOwnProperty("errorBeaconLevel") && (n = o.errorBeaconLevel,
        typeof n == "number" && n % 1 == 0 && n >= 0 && n <= 2 && (this.uetConfig.errorBeaconLevel = n));
        ...
        for (t in o)
            r.hasOwnProperty(t) && (this.beaconParams[t] = r[t] === 1 ? encodeURIComponent(o[t]) : o[t])
    }
    ;
    this.loadConfig();
    this.push = function() {
        var t = arguments, r, i, u = !1;
        if (t.length === 1)
            if (r = "event",
            t[0] === this.pageLoadEvt)
                i = [this.pageViewEvt, {}],
                u = !0;
            else {
    ...
    this.dispatchq = function() {
        var n, t, i, r, f, e, u;
        for (this.evqDispatch = !0,
        i = 0; i < this.evq.length; i++)
            if (typeof this.evq[i] == "object") {
                ...
                n === "set")
                    ...
                    t !== undefined && (this.push(n, t, f ? {} : r),
                    f && this.push(r))
                } else
                    this.push(r);
                n = t = undefined
            } else
                typeof this.evq[i] == "string" || this.evq[i]instanceof String ? (n !== undefined && t !== undefined && (this.push(n, t, {}),
                n = t = undefined),
                u = this.evq[i],
                n === undefined && (u === "set" || u === "event") ? n = u : n !== undefined && t === undefined ? t = u : n = t = undefined,
                i === this.evq.length - 1 && n === "event" && t !== undefined && this.push(n, t, {})) : n = t = undefined
    }
    ;
    ...
    this.createInvisibleElement = function(n, t) {
        ...
        i.id = "batBeacon" + Math.random("bat"),
        n.appendChild(i),
        i
    }
    ;
    ...
    this.addFraudSignals = function(n) {
        ...
        return this.stringExists(t) && (n.lg = t),
        screen && (screen.width && (n.sw = screen.width),
    ...
    this.addUrlData = function(n) {
        ...
        if (this.stringExists(t) && (n.r = encodeURIComponent(t),
        r = t.split("?")[0]),
        window.self != window.top)
            n.hasOwnProperty("r") && (n.p = n.r,
            n.r = "");
        else {
    ...
    this.addPageData = function(n, t) {
        ...
        this.stringExists(i) && !this.stringExists(n.tl) && (n.tl = encodeURIComponent(i).replace(/%2C/gi, ",")),
        window.document.head.getElementsByTagName("meta").keywords && (r = window.document.head.getElementsByTagName("meta").keywords.content,
        this.stringExists(r) && (n.kw = encodeURIComponent(r).replace(/%2C/gi, ","))),
    ...
    this.validateValue = function(n, t, i, r) {
        ...
        u > r ? this.throwError(n + " cannot be greater than " + r) : u < 0 ? this.throwError(n + " cannot be less than 0") : this.getDecimalPlaces(u) > i && this.throwError(n + " cannot have more than " + i + " decimal places"),
        u
    }
    ;
    ...
    this._validateProdId = function(n) {
        ...
        this.validateRegex(n, /^[a-zA-Z0-9\-]{1,50}$/, this.invalidProdIdException)
    }
    ;
    this.validateProdId = function(n) {
        ...
        if (n instanceof Array) {
            for (i = 0; i < n.length; i++)
                n[i] !== null && n[i] !== undefined && (t += t !== "" ? "," : "",
                t += this._validateProdId(n[i]));
            t === "" && this.throwError(this.invalidProdIdException)
        } else
            t = this._validateProdId(n);
        return t
    }
    ;
    ...
    this.validateParameterArray = function(n, t) {
        for (var i = 0; i < n.length; i++)
            typeof n[i] == "object" && (n[i] = this.validateSubparams(n[i], t + "."),
    ...
    this.validateDataObjectNew = function(n, t) {
        ...
        t.hasOwnProperty("ecomm_pagetype") ? t.hasOwnProperty("ecomm_prodid") && (t.ecomm_prodid = this.validateProdId(t.ecomm_prodid)) : t.hasOwnProperty("ecomm_prodid") && this.throwError(this.missingPageTypeException),
        (t.hasOwnProperty("hct_base_price") || t.hasOwnProperty("hct_booking_xref") || t.hasOwnProperty("hct_pagetype") || t.hasOwnProperty("hct_checkin_date") || t.hasOwnProperty("hct_checkout_date") || t.hasOwnProperty("hct_length_of_stay") || t.hasOwnProperty("hct_partner_hotel_id")) && (t.hasOwnProperty("hct_total_price") && t.hasOwnProperty("currency") || this.throwError(this.missingHotelParametersException)),
        t.hasOwnProperty("hct_total_price") && t.hasOwnProperty("gv") && this.throwError(this.hotelVariableRevenueException),
        r = t.event_action,
        r != null && this.knownEvents.hasOwnProperty(r)) {
            u = this.knownEvents[r];
            for (f in u)
                i = u[f],
                this.pageLevelParams.hasOwnProperty(i) && !t.hasOwnProperty(i) && (t[i] = this.pageLevelParams[i])
        }
    ...
    this.validateDataObject = function(n, t) {
        ...
        for (i in t)
            n === this.customEvt && (this.legacyValidCustomEventKeyNames[i] || this.ambiguousValidCustomEventKeyNames[i]) || this.throwError(this.invalidKeyException + i);
    ...
    this.evt = function(n, t, i, r) {
        ...
        if (r = r !== !1,
        i = i || {},
        this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(),
        typeof i == "object") {
            if (r ? this.validateDataObject(n, i) : (i.event_action = t,
            ...
            n === this.customEvt) {
                ...
                if (i.ea != null && this.knownEvents.hasOwnProperty(i.ea)) {
                    ...
                    for (o in i)
                        a.indexOf(o) === -1 && delete i[o]
                }
                if (s = !r && i.hasOwnProperty("page_path"),
                s) {
                    if (i.spa = "Y",
                    ...
                    u.hasOwnProperty("pn") && (i.pn = u.pn)) : this.beaconParams.mid = this.getGuid(),
                    i.hasOwnProperty("page_title") && (i.tl = i.page_title,
                    delete i.page_title),
                    this.stringExists(this.previousPage)) {
                        if (h = this.previousPage.toUpperCase(),
                        f = h.indexOf("%3A%2F%2F"),
                        f === -1)
                            return;
                        v = i.page_path.substring(0, 3).toUpperCase() === "%2F";
                        v ? (f += 9,
                        c = h.indexOf("%2F", f),
                        i.p = c === -1 ? this.previousPage + i.page_path : this.previousPage.substring(0, c) + i.page_path) : i.p = this.previousPage
                    }
                } else {
    ...
    this.getCookie = function(n, t, i) {
        var r, u, e, f, o;
        if (!this.stringExists(n) || !this.stringExists(t) || (r = document.cookie,
        r.length === 0))
            return null;
        for (e = 0; e < r.length; ) {
    ...
    this.setCookie = function(n, t, i, r, u, f) {
        var s, c, h, o, e;
        if (!this.stringExists(n) || !this.stringExists(u) || !this.stringExists(t) || t.length > f)
            return null;
        if (s = new Date,
        ...
        this.domainName === null || r) {
            if (h = document.location && document.location.hostname,
            h && typeof h == "string" && h !== "localhost")
                for (o = h.split("."),
                e = o.pop(),
                o.length === 3 && Number(e) >= 0 && (o = []); o.length > 0; )
                    if (e = o.pop() + "." + e,
                    r && (this._setCookie(n, "", c.toUTCString(), e),
                    r = !!this.getCookie(n, u, f)),
                    !r && (this._setCookie(n, u + t, s.toUTCString(), e),
                    this.getCookie(n, u, f))) {
                        this.domainName = e;
                        return
                    }
            this.domainName = ""
    ...
    this.addMsClkId = function(n) {
        if (o.Ver < 2 || this.uetConfig.cookieAllowed === !1)
            return n;
        this.extractMsClkId(this.addUrlData({}));
        var t = "0";
        return this.stringExists(this.msClkId) ? this.getCookie(this.msClkIdCookieName, this.msClkIdCookieValuePrefix, this.lengthMsClkId) !== this.msClkId && (t = "1") : this.msClkId = this.getCookie(this.msClkIdCookieName, this.msClkIdCookieValuePrefix, this.lengthMsClkId),
        this.stringExists(this.msClkId) ? (this.setCookie(this.msClkIdCookieName, this.msClkId, this.msClkIdExpirationTime, !0, this.msClkIdCookieValuePrefix, this.lengthMsClkId),
        this.getCookie(this.msClkIdCookieName, this.msClkIdCookieValuePrefix, this.lengthMsClkId) !== this.msClkId && (t += "N"),
        n.msclkid = encodeURIComponent(this.msClkId + "-" + t)) : n.msclkid = "N",
        n
    }
    ;
    this.createIframe = function(n) {
        return this.invisibleFrame = this.createInvisibleElement(n, "iframe"),
        this.invisibleFrame.src = "",
        this.invisibleFrame.name = this.invisibleFrame.id,
        this.invisibleFrame.id
    }
    ;
    ...
    this.addHiddenFields = function(n, t, i, r) {
        ...
        r && (e = r + ".");
        for (u in n)
            n.hasOwnProperty(u) && (typeof n[u] == "object" ? this.addHiddenFields(n[u], t, i, e + u) : (f = i.createElement("input"),
            f.setAttribute("type", "hidden"),
            f.setAttribute("name", e + u),
            f.setAttribute("value", n[u]),
            t.appendChild(f)))
    }
    ;
    this.fireBeacon = function(n) {
        for (var r, e = this.urlPrefix, s = this.postURL, t = this.combine(this.beaconParams, n), u = this.stringifyToRequest(t), f = this.removeTrailingAmp(e + u), o = ["el2", "ec2", "ea2", "page_location", "page_path", "kw", "p", "tl", "items"], i = 0; encodeURI(f).length > this.URLLENGTHLIMIT && o.length > i; i++)
            (r = o[i],
            r in t) && (i <= 2 ? t[r] = "" : delete t[r],
